      ...
      <div class="max-w-4xl w-full">
        ...
        <div class="bg-white/70 backdrop-blur-sm rounded-2xl shadow-2xl p-8 md:p-12 border border-blue-100 transition-all duration-700 ease-out">
          ...
          <div class="flex flex-wrap gap-3">
            ...
            <a href="https://x.com/joeltankam" target="_blank" rel="noopener noreferrer"
              ...
              <span class="text-gray-700 font-medium group-hover:text-black transition-colors">@joeltankam</span>
            </a>
