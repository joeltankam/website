      ...
      <div class="max-w-4xl w-full">
        ...
        <div class="bg-white/70 backdrop-blur-sm rounded-2xl shadow-2xl p-8 md:p-12 border border-primary-100 transition-all duration-700 ease-out">
          ...
          <div class="flex flex-wrap gap-3">
            ...
            <a :href="`https://bsky.app/profile/${siteConfig.social.bluesky}`" target="_blank" rel="noopener noreferrer"
              class="inline-flex items-center space-x-2 px-4 py-2 bg-white/50 border-2 border-primary-200 rounded-xl hover:border-blue-500 hover:bg-white transition-all duration-300 shadow-md hover:shadow-lg group">
              ...
              <span class="text-gray-700 font-medium group-hover:text-blue-600 transition-colors">@{{ siteConfig.social.bluesky }}</span>
            </a>
...
const seoMeta = computed(() => {
  ...
  return {
    title: `${siteConfig.author} - Software Engineer`,
    ...
    keywords: [siteConfig.author, 'software engineer', 'Paris', 'vue.js', 'typescript', '.net', 'distributed systems'],
