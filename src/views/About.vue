      ...
      <div class="max-w-6xl mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          ...
          <div class="text-right">
            <h2 class="text-lg font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">About Me</h2>
          </div>
        </div>
      </div>
    </header>
    ...
    <main class="max-w-4xl mx-auto px-6 py-12">
      ...
      <div class="bg-white/70 backdrop-blur-sm rounded-2xl p-8 lg:p-12 shadow-2xl border border-blue-100 mb-8">
        ...
        <div class="space-y-4 text-lg text-gray-700 leading-relaxed">
          ...
          <p>
            On the professional side, I work as a <span class="font-semibold text-gray-800">software engineer and technical lead</span> with over <span class="font-bold text-blue-600">{{ yearsOfExperience }} years of experience</span> at <span class="font-bold text-blue-600">Société Générale Corporate & Investment Banking</span>. I started my career in <span class="font-semibold text-gray-800">Morocco</span>, where I worked for two years before being relocated to <span class="font-semibold text-gray-800">Paris</span>. I specialize in the <span class="font-semibold text-gray-800">.NET ecosystem</span>, focusing on building scalable systems and tools that make developers' lives easier. I graduated from the <span class="font-bold text-blue-600">Mohammadia School of Engineers in Morocco</span> with a Master of Engineering in Computer Science.
          </p>
        </div>
      </div>
      ...
      <div class="bg-white/70 backdrop-blur-sm rounded-2xl p-8 lg:p-12 shadow-2xl border border-blue-100 mb-8">
        ...
        <div class="space-y-4">
          <div>
            <h3 class="text-sm font-semibold text-blue-600 uppercase tracking-wide mb-2">Proficient With</h3>
            <div class="flex flex-wrap gap-2">
              <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200">.NET Ecosystem</span>
              <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200">C#</span>
              <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200">ASP.NET Core</span>
              <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200">MSBuild</span>
              <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200">PowerShell</span>
              <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200">CI/CD</span>
              <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200">Software Architecture</span>
              <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-medium border border-blue-200">Git</span>
            </div>
          </div>

          <div>
            <h3 class="text-sm font-semibold text-blue-600 uppercase tracking-wide mb-2">Familiar With</h3>
            <div class="flex flex-wrap gap-2">
          ...
          <div>
            <h3 class="text-sm font-semibold text-blue-600 uppercase tracking-wide mb-2">Experience With</h3>
            <div class="flex flex-wrap gap-2">
      ...
      <!-- Contact -->
      <div class="bg-white/70 backdrop-blur-sm rounded-2xl p-8 lg:p-12 shadow-2xl border border-blue-100">
        <h2 class="text-3xl font-bold text-gray-800 mb-6">Let's Connect</h2>
        
        <p class="text-gray-600 mb-6">
          I'm always interested in hearing about new opportunities, collaborating on interesting projects, or discussing technology and software engineering. Feel free to reach out!
        </p>
        ...
        <div class="flex flex-wrap gap-4">
          ...
          <a href="https://twitter.com/joeltankam" target="_blank" class="inline-flex items-center px-6 py-3 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors">
            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="mailto:joel.tankam@gmail.com" class="inline-flex items-center px-6 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-colors">
        ...
        <div class="mt-8 pt-8 border-t border-gray-200">
          ...
          <div class="flex gap-6">
            <div>
              ...
              <span class="text-blue-600 ml-2">Native</span>
            </div>
            <div>
              <span class="font-medium text-gray-700">English:</span>
              <span class="text-blue-600 ml-2">Mastery</span>
            </div>
          </div>
        </div>
      </div>
